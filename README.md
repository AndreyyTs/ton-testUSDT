...
A minimal **testnet Jetton faucet** (TEP‑74 style master + wallet) on **TON Testnet**: connect with **Ton Connect** (e.g. Tonkeeper on testnet), enter an amount, and claim tokens to your **jetton wallet**—no manual contract calls or explorer gymnastics.

This repo hosts **static files** only (`index.html`, JS bundle, **Ton Connect manifest**) for **GitHub Pages**.
